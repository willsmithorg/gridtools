...
class TestColumnDeriverTokenizerCharDecimal(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.col3 = Column(pd.Series(['AB101X','AB1033=Y','XY123','MYN199F3','123ABC', 'mmm.123', '999'],           name='col3'))
    ...
    def testTokenizerCharDecimalOnAllPositive(self):
        ...
        self.assertTrue(pd.Series.equals(newcols[0].series, pd.Series(['AB', 'AB',  'XY', 'MYN', 'ABC',     'mmm',   None])))       
        self.assertTrue(pd.Series.equals(newcols[1].series, pd.Series(['X',  'Y',   None,   'F',   None,     None,   None])))     
        self.assertTrue(pd.Series.equals(newcols[2].series, pd.Series(['X', 'Y',   'XY',    'F', 'ABC',     'mmm',   None])))       
        self.assertTrue(pd.Series.equals(newcols[3].series, pd.Series(['AB',  'AB', None, 'MYN',   None,     None,   None])))  
        
        
        self.assertTrue(pd.Series.equals(newcols[4].series, pd.Series(['101','1033','123','199',  '123',     '123',  '999']))) 
        self.assertTrue(pd.Series.equals(newcols[5].series, pd.Series([None   ,None, None,   '3',   None,    None,   None  ])))   
        self.assertTrue(pd.Series.equals(newcols[6].series, pd.Series(['101','1033','123',   '3',  '123',     '123', '999']))) 
        self.assertTrue(pd.Series.equals(newcols[7].series, pd.Series([None   ,None, None, '199',   None,    None,   None  ])))         
        
        self.assertTrue(pd.Series.equals(newcols[8].series, pd.Series([False, False, False, False, True,     False,   True])))   
